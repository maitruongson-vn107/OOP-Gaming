...
public class Board extends Parent {
    ...
    public boolean placeShip(AirCraft airCraft, int x, int y) {
        if (canPlaceShip(airCraft, x, y)) {
    ...
    private boolean canPlaceShip(AirCraft airCraft, int x, int y) {
        int length = airCraft.type;
